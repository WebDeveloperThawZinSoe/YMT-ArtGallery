      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="index.php" class="nav-link  <?php  if(basename($_SERVER['SCRIPT_FILENAME'])=="index.php"){ echo "active"; }else{ echo ""; }  ?>  "  >
          ...
          <li class="nav-item">
            <a href="account.php" class="nav-link <?php  if(basename($_SERVER['SCRIPT_FILENAME'])=="account.php"){ echo "active"; }else{ echo ""; }  ?>">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="overall.php" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Overall Page Setting</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link">
