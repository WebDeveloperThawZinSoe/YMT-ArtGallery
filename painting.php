...
<section data-bs-version="5.1" class="gallery2 cid-t7w2E2zmxP" id="gallery2-m" style="background-color: gray !important;">
    ...
    <div class="container">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style align-center m-0 display-2" style="font-size:28px;font-weight: bolder;">My Gallery</h4>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-6">
                <div class="item-wrapper">
                    ...
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5" style="font-size:20px"><?php echo $r['title'] ?></h5>
                        
                        
                    </div>
                    <div class="mbr-section-btn item-footer mt-2">
                        <a href="#myModal<?php echo $r['id'] ?>" class="btn btn-primary item-btn display-7" target="_blank" data-bs-toggle="modal" style="font-size:20px !important">View </a>
                    </div>
                </div>
            </div>
